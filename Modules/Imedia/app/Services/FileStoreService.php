...
class FileStoreService
{
   ...
   * Validations to File
   */
  private function validationsFile($file): void
  {
   ...
   */
  private function checkFileExist($fileName, $fileSize): mixed
  {
   ...
   */
  private function checkFilenameExist($fileName, $parentId, $disk): string
  {
    $params = [
      "filter" => [
   ...
   */
  private function getNewUniqueFilename($fileName, $models): string
  {
